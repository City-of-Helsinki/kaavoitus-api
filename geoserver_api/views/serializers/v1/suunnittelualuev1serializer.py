...
class SuunnittelualueV1Serializer(serializers.Serializer):
    ...
    keskimaarainen_tonttitehokkuus = serializers.CharField(required=False, allow_null=True)
    maanalaisten_tilojen_pinta_ala_yht = serializers.CharField(required=False, allow_null=True)
    aluevarausten_pinta_alat_yht = serializers.CharField(required=False, allow_null=True)
    pinta_alan_muutokset_yht = serializers.CharField(required=False, allow_null=True)
    suojellut_rakennukset_maara_yht = serializers.CharField(required=False, allow_null=True)
    suojellut_rakennukset_ala_yht = serializers.CharField(required=False, allow_null=True)
