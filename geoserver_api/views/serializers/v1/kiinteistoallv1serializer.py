...
class KiinteistoAllV1Serializer(serializers.Serializer):
    ...
    rekisterilaji = serializers.ChoiceField(choices=[(type, desc) for type, desc in REKISTERILAJI.items()])
    ...
    rakennuskiellot = serializers.ListField(child=RakennuskieltoV1Serializer())
    """
