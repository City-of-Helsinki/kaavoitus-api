...
from .v1.rakennuksen_omistajat import API as APIv1
from .serializers.v1 import RakennuksenOmistajatV1Serializer
...
class API(APIView):
    ...
    @extend_schema(
        responses={
            200: RakennuksenOmistajatV1Serializer,
        ...
        description="Hae rakennuksen omistajatiedots kiinteistötunnuksella",
